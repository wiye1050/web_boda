  ...
  return (
    <footer className="relative mt-4 md:mt-20 pt-16 pb-32 md:pb-16 px-6 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="glass rounded-[3rem] p-6 md:p-16 shadow-premium border-black/5 flex flex-col items-center text-center">
          
          <div className="mb-12">
            <h3 className="font-serif text-3xl md:text-5xl text-foreground mb-4">
              La cuenta atrás ha empezado
            </h3>
            <p className="text-[10px] md:text-xs tracking-[0.4em] text-foreground/40 uppercase font-sans">
              Nos vemos pronto
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-16 mb-16 w-full max-w-2xl">
            <div className="flex flex-col items-center">
              ...
              <span className="text-[9px] tracking-[0.2em] text-foreground/30 uppercase font-sans">Días</span>
            </div>
            <div className="flex flex-col items-center border-l border-black/5 md:border-l-0">
              <span className="text-4xl md:text-6xl font-serif text-accent mb-2">{String(timeLeft.hours).padStart(2, '0')}</span>
              <span className="text-[9px] tracking-[0.2em] text-foreground/30 uppercase font-sans">Horas</span>
            </div>
            <div className="flex flex-col items-center border-t border-black/5 md:border-t-0 pt-8 md:pt-0">
              <span className="text-4xl md:text-6xl font-serif text-accent mb-2">{String(timeLeft.minutes).padStart(2, '0')}</span>
              <span className="text-[9px] tracking-[0.2em] text-foreground/30 uppercase font-sans">Min</span>
            </div>
            <div className="flex flex-col items-center border-l border-t border-black/5 md:border-t-0 md:border-l-0 pt-8 md:pt-0">
              <span className="text-4xl md:text-6xl font-serif text-accent mb-2">{String(timeLeft.seconds).padStart(2, '0')}</span>
              <span className="text-[9px] tracking-[0.2em] text-foreground/30 uppercase font-sans">Seg</span>
            </div>
          </div>

          <div className="w-12 h-[1px] bg-black/10 mb-12" />

          {/* Bottom Text */}
          <div className="flex flex-col gap-6 items-center">
            <div className="text-[10px] tracking-[0.5em] text-foreground/40 uppercase leading-relaxed font-sans">
