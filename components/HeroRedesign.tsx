    ...
    >
      ...
      <div className="z-10 flex flex-col items-center w-full">
        <div className="relative pt-8 mb-4">
          <h1 className="text-5xl sm:text-7xl md:text-[8rem] font-serif italic tracking-tighter leading-[0.85] text-center">
            <span className="relative z-10 flex flex-col md:flex-row justify-center items-center gap-y-2 md:gap-x-16">
              ...
              <motion.span 
                ...
                className="text-accent font-script text-[4.5rem] sm:text-[6rem] md:text-[7rem] lg:text-[9rem] drop-shadow-sm -translate-y-1 md:-translate-y-2 -my-2 md:my-0 z-20 will-change-transform transform-gpu"
              >
                &
              </motion.span> 
